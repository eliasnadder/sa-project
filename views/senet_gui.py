...
from views.text_input_box import TextInputBox
...
class SenetGUI:
    def __init__(self):
        ...
        self.btn_slow = Button(SCREEN_WIDTH//2 - 150, 300,
                               300, 60, "Slow AI", "SLOW")
        self.btn_medium = Button(
            SCREEN_WIDTH//2 - 150, 380, 300, 60, "Medium AI", "MEDIUM")
        self.btn_fast = Button(SCREEN_WIDTH//2 - 150, 460,
                               300, 60, "Fast AI", "FAST")
